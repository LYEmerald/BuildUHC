package net.endlight.buhc.room;
...
import net.endlight.buhc.event.GameCloseEvent;
import net.endlight.buhc.event.GameRoomStartEvent;
import net.endlight.buhc.event.PlayerJoinRoomEvent;
import net.endlight.buhc.event.PlayerQuitRoomEvent;
import net.endlight.buhc.manager.RandomJoinManager;
import net.endlight.buhc.manager.RoomManager;
import net.endlight.buhc.manager.TotalManager;
import net.endlight.buhc.manager.WorldResetManager;
import net.endlight.buhc.player.PlayerInfo;
import net.endlight.buhc.player.team.TeamInfo;
import net.endlight.buhc.player.team.config.TeamInfoConfig;
import net.endlight.buhc.room.config.GameRoomConfig;
import net.endlight.buhc.room.config.ItemConfig;
import net.endlight.buhc.room.floattext.FloatTextInfo;
import net.endlight.buhc.room.floattext.FloatTextInfoConfig;
import net.endlight.buhc.room.world.WorldInfo;
import net.endlight.buhc.tools.Utils;
import net.endlight.buhc.item.button.FollowItem;
import net.endlight.buhc.item.button.RoomQuitItem;
import net.endlight.buhc.item.button.TeamChoseItem;
import net.endlight.buhc.room.event.EventControl;
...
public class GameRoom {
    ...
    public JoinType joinPlayerInfo(PlayerInfo info,boolean sendMessage){
        ...
        if(info.getGameRoom() == null){
            ...
            sendMessage(info+"&e已加入 &7("+(playerInfos.size()+1)+"/"+getRoomConfig().getMaxPlayerSize()+")");
            info.init();
            ...
            case START:
                ...
                try {
                    ...
                    for(PlayerInfo playerInfo: new ArrayList<>(playerInfos)){
                        playerInfo.sendForceMessage("房间出现异常");
                    }
                    onDisable();
                    return;
                }
    ...
    private void onStart() {
        ...
        if(loadTime == -1 && teamAll){
            ...
            sendTitle("");
            sendMessage("&b游戏正式开始! &6让对面死亡吧!");
            sendSubTitle("&b游戏正式开始！&6让对面死亡吧！");
    ...
    private void onWait() {
        if(getPlayerInfos().size() >= getRoomConfig().minPlayerSize){
            if(loadTime == -1){
                ...
                sendMessage("&e游戏将在&l&6 "+loadTime+"&l&6秒"+" &r&e后开始");
        ...
        if(loadTime >= 1) {
            sendTip("&e游戏将在&l&6 "+loadTime+"&l&6秒"+" &r&e后开始");
            if(loadTime <= 10){
                switch (loadTime){
                    case 10: sendTitle("");sendSubTitle("&e游戏将在 &l&610秒 &r&e后开始");break;
                    case 9: sendTitle("");sendSubTitle("&e游戏将在 &l&69秒 &r&e后开始");break;
                    case 8: sendTitle("");sendSubTitle("&e游戏将在 &l&68秒 &r&e后开始");break;
                    case 7: sendTitle("");sendSubTitle("&e游戏将在 &l&67秒 &r&e后开始");break;
                    case 6: sendTitle("");sendSubTitle("&e游戏将在 &l&66秒 &r&e后开始");break;
                    case 5: sendTitle("");sendSubTitle("&e游戏将在 &l&65秒 &r&e后开始");break;
                    case 4: sendTitle("");sendSubTitle("&e游戏将在 &l&64秒 &r&e后开始");break;
                    case 3: sendTitle("");sendSubTitle("&e游戏将在 &l&63秒 &r&e后开始");break;
                    case 2: sendTitle("");sendSubTitle("&e游戏将在 &l&62秒 &r&e后开始");break;
                    case 1: sendTitle("");sendSubTitle("&e游戏将在 &l&61秒 &r&e后开始");break;
                    default:
                        sendTitle("");break;
            ...
            sendTip("&7当前游戏: &l&aBuild &bUHC &r&7游戏状态: &l&b等待中");
        }
    }
