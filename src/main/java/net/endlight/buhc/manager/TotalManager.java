...
import net.endlight.buhc.manager.data.PlayerDataManager;
import net.endlight.buhc.manager.data.PlayerTopManager;
import net.endlight.buhc.panel.lib.AbstractFakeInventory;
import net.endlight.buhc.room.config.GameRoomConfig;
import net.endlight.buhc.room.event.defaults.CommandEvent;
import net.endlight.buhc.room.event.defaults.CustomEvent;
import net.endlight.buhc.room.event.defaults.EffectEvent;
...
public class TotalManager {
     ...
     * 游戏指令
     * */
    public static final String COMMAND_NAME = "buhc";

    /**
     * 游戏管理员指令
     * */
    public static final String COMMAND_ADMIN_NAME = "buhca";

    /**
     * 游戏内喊话指令
     * */
    public static final String COMMAND_MESSAGE_NAME = "buhcs";

    /**
     * 小游戏名称
     * */
    public static final String GAME_NAME = "BuildUHC";
    ...
    public static void sendMessageToObject(String msg, Object o){
        String message = TextFormat.colorize('&',getTitle()+"&r "+msg);
